...
RULES: List[InstructionRule] = [
    ...
    InstructionRule(
        ...
        text=(
            ...
            'replace acceptance criteria. If an acceptance criterion explicitly requires a command to pass, '
            'include that exact command and its discovered working directory in the same item\'s required_checks. '
            'A test of a validator is not a substitute for running that validator on the actual deliverable.\n'
    ...
    InstructionRule(
        ...
        text=(
            ...
            'calls. When local search is offered, use path/glob to focus it and follow next_cursor with '
            'the same arguments while has_more. Restart without cursor after a stale-source error. '
            'A partial page, skipped file or clipped text is not evidence of absence; inspect the '
            'remaining scope or full lines before making completeness claims. '
    ...
    InstructionRule(
        ...
        text=(
            ...
            'decision on every request. Keep records concise and batches small; send the final decision '
            'separately. Reuse returned citation objects. A conditional requirement '
