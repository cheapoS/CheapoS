...
def plan(engine, runtime, inputs):
    ...
    while attempt < 3:
        ...
        try:
            ...
            feedback = 'The proposal was invalid: ' + str(error)[:1000] + hint + '. Return a complete corrected proposal or ask clarification. No work has been authorized.'
