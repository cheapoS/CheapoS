...
| --- | --- | --- | --- | --- |
| [T01](docs/tasks/T01-task-metadata.md) | Persistent task metadata and lifecycle API foundation | — | M | Todo |
| [T02](docs/tasks/T02-task-titles.md) | Useful task titles, editable names, one clear header | T01 | M | Todo |
| [T03](docs/tasks/T03-sidebar.md) | Sidebar menus, pin/archive, collapse, and full history | T01, T02 | M | Todo |
| [T04](docs/tasks/T04-trash-backend.md) | Recoverable Delete/Restore backend | T01 | M | Todo |
...
| [T13](docs/tasks/T13-verification-evidence.md) | Suitable check timeouts and reusable verification evidence | T09, T12 | L | Todo |
| [T14](docs/tasks/T14-checkpoint-boundaries.md) | Internal checkpoint boundaries with hard outer limits | T13 | M | Todo |
