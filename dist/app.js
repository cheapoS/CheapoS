...
async function operatorRecovery(task){
 const d=dialog(`${modalHeader('SAVED TASK RECOVERY','Choose how to continue')}<div data-recovery-body role="status">Loading available recovery actions…</div>`,'execution-modal');
