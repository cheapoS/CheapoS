...
function renderComposer() {
  ...
  $('#chat-budget').textContent=`${chosenLimits.dollars===0?'Free only':money(chosenLimits.dollars)+' cap'} · ${chosenLimits.uncapped_work?'Uncapped work ∞':`${preset==='custom'?'Custom':preset==='extended'?'Extended':'Standard'} ${chosenLimits.run_minutes??15} min`}`;
