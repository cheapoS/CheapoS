...
window.addEventListener('keydown',e=>{if(e.key==='/'&&!['INPUT','TEXTAREA'].includes(document.activeElement.tagName)){const modal=$('dialog.search-modal[open]');if(modal){e.preventDefault();modal.close();}}});
