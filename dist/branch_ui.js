...
return {mergeAndPublish,mergeProgressMarkup,fullSuiteConsent,diffPath,reviewDiffs,reviewFiles,reviewDiffMarkup,finalReviewMarkup,finalDiffState,mountFinalDiff,planningPayload,proposalValidation,technicalEvents,technicalPage,technicalText,technicalMarkup,startController,savedPlan,planMarkup,pausePresentation,pauseMarkup,reviewAction,proposalReadiness,proposalStartBlocked,mount,intent,terminalRun,hasRun,isPlanning,duration,isBusy,isRevisionTarget,resumeAction,proposedLimits,projectRun,diffSections,escape};
});
