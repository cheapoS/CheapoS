# Optional Carto project context

Enable **Project menu → Project context → Use Carto for this project → Save**.
Install the optional local parser first, from the cheapoS checkout:
...
The first context request creates an index in the active cheapoS profile's
...
models, network, Git workflows or real-time waits. Eight cases ran in 0.059s.
